...
# Read the file
with open(r'd:\EWM Robot\Robotic Platform Codes\sap-bridge\clients\zewm_robco_client.py', 'r', encoding='utf-8') as f:
    content = f.read()
...
if match:
    ...
    # Write back
    with open(r'd:\EWM Robot\Robotic Platform Codes\sap-bridge\clients\zewm_robco_client.py', 'w', encoding='utf-8') as f:
        f.write(content)
    ...
    simple_pattern = r'(\s+def close\(self\) -> None:\s*\n\s+""".*?"""\s*\n)(.*?\s+logger\.debug.*?\n)'
