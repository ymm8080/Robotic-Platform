...
class CapabilityVector:
    ...
    def can_traverse(self, env: EnvConstraints) -> bool:
        ...
        """
        return (
            self.env.max_grade >= env.max_grade and self.env.floor_threshold >= env.floor_threshold
        )
...
class SensorHealth:
    ...
    def worst(self) -> HealthStatus:
        return max(self.velocity_sensor, self.lidar, self.camera, self.time_sync)
